...
// Generated from tools/xbe_parser KERNEL_EXPORTS (X-Men recomp).

namespace OgXbox.Recomp.Codegen.Binary;

public static class XboxKernelExports
{
    public static readonly System.Collections.Generic.IReadOnlyDictionary<int, string> ByOrdinal =
    ...
    public static string Name(int ordinal) =>
        ByOrdinal.TryGetValue(ordinal, out var n) ? n : $"Ordinal_{ordinal}";
}
